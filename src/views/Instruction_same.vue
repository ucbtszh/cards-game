    ...
    <swiper class="swiper" :options="swiperOption">
      <swiper-slide>
        <div class="instruction">
          ...
          A large number of participants played this game before. We collected all their game responses. <br />
          You will play the game three times, with a <b>different</b> participant from a previous study in <b>each game</b>.<br /><br />
