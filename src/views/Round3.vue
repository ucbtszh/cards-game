...
<script>
import t1_1 from "@/assets/fu_single_player0.json";
import t2_1 from "@/assets/fu_single_player1.json";
import t3_1 from "@/assets/fu_single_player2.json";
import t4_1 from "@/assets/fu_single_player3.json";
import t5_1 from "@/assets/fu_single_player4.json";
import t6_1 from "@/assets/fu_single_player5.json";
import t7_1 from "@/assets/fu_single_player6.json";
import t8_1 from "@/assets/fu_single_player7.json";
import t9_1 from "@/assets/fu_single_player8.json";
import t10_1 from "@/assets/fu_single_player9.json";
...
export default {
  ...
  created() {
    if (this.$order === "otherFirst") {
      this.trials = this.$block1
    } else {
      this.trials =
        this.$condition == "t1"
          ? t1_1
