    ...
    <div id="c3" v-show="showC3">
      <v-form v-model="isvalid3">
        ...
        >
          <v-radio
            value="a"
            label="You win £0.05. The other player wins nothing."
          >
          </v-radio>
          <v-radio
            value="b"
            label="The other player wins £0.05. You win nothing."
          >
          </v-radio>
          <v-radio
            value="c"
            label="You win £0.05. The other player loses £0.05."
          >
          </v-radio>
          <v-radio
            value="d"
            label="The other player wins £0.05.  You lose £0.05."
          >
          </v-radio>
        </v-radio-group>
        <v-btn
