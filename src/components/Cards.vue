<template>
  <div :id="index">
    <h3>{{ header }}</h3>
    <p v-show="trial" style="display:inline-block">Remember that the other player was handed exactly the same cards and that their random card pick is not necessarily the same as yours.</p>
    <br>
